...
# from CodexRobot.modules.sql import warns_sql as warnssql
import CodexRobot.modules.sql.blacklist_sql as blacklistsql

# from CodexRobot.modules.sql import cust_filters_sql as filtersql
# import CodexRobot.modules.sql.welcome_sql as welcsql
import CodexRobot.modules.sql.locks_sql as locksql
import CodexRobot.modules.sql.notes_sql as sql

# from CodexRobot.modules.rules import get_rules
import CodexRobot.modules.sql.rules_sql as rulessql
from CodexRobot import JOIN_LOGGER, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from CodexRobot.__main__ import DATA_IMPORT
from CodexRobot.modules.connection import connected
from CodexRobot.modules.helper_funcs.alternate import typing_action
from CodexRobot.modules.helper_funcs.chat_status import user_admin
from CodexRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("CodexRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("CodexRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `CodexRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("CodexRobot{}.backup".format(chat_id))  # Cleaning file
